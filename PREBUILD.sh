...
(
  ...
  # Build for arm64-v8a
  ~/.cargo/bin/cargo ndk -t arm64-v8a --platform 21 build --locked --release --features aws_lambda

  # Build for armeabi-v7a
  ~/.cargo/bin/cargo ndk -t armeabi-v7a --platform 21 build --locked --release --features aws_lambda
)
